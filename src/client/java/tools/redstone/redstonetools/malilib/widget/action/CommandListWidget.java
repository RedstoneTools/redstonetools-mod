...
public class CommandListWidget extends AbstractSelectionList<CommandListWidget.CommandEntry> {
	...
	@Override
	public boolean mouseClicked(/*$ mouse_clicked_params {*/MouseButtonEvent click, boolean doubleClick/*$}*/) {
	...
	@Override
	public boolean keyPressed(/*$ keyinput_params {*/KeyEvent input/*$}*/) {
	...
	*///?}
	...
	public class CommandEntry extends Entry<CommandEntry> {
		...
		@Override
		public boolean mouseReleased(/*$ dragged_released_params {*/MouseButtonEvent click/*$}*/) {
			removeButton.onMouseReleased(/*$ on_released_args {*/click/*$}*/);
			return commandWidget.mouseReleased(/*$ dragged_released_args {*/click/*$}*/);
		}

		@Override
		public boolean mouseDragged(/*$ dragged_released_params {*/MouseButtonEvent click/*$}*/, double deltaX, double deltaY) {
		...
		@Override
		public boolean keyReleased(/*$ keyinput_params {*/KeyEvent input/*$}*/) {
			return commandWidget.keyReleased(/*$ keyinput_args {*/input/*$}*/);
		}

		@Override
		public boolean charTyped(/*$ charinput_params {*/CharacterEvent input/*$}*/) {
